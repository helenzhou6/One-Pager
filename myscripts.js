(function () {
	'use strict';
  var textElem = document.querySelectorAll('.photo__text');
	var slides = document.querySelectorAll('.photo'),
		 arrows = document.querySelectorAll('.arrow--js'),
		 carouselCount = 0,
		 scrollInterval,
		 interval = 9000;
	...
	function slider() {
      ...
      textElem[i].setAttribute('style', 'transform:translateX(-' + carouselCount + '%)');
